...
<head>
    ...
    {{-- Favicon --}}
    <link rel="shortcut icon" type="image/png" href="{{ asset('img/logo-rs.png') }}" />

    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('img/logo-rs.png') }}" />

    <link rel="apple-touch-icon" href="{{ asset('img/logo-rs.png') }}" />
