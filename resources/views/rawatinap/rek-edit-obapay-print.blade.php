    ...
    @if (($obapayEditPrint ?? collect())->count())
        ...
        <table class="nb">
            <thead>
                <tr>
                    <th style="width:30%;"></th>
                    <th style="width:20%;" class="center">TANGGAL</th>
                    <th style="width:25%;" class="center">NO TRANSAKSI</th>
                    <th style="width:20%;" class="right">BIAYA</th>
                    <th style="width:5%;"></th>
                </tr>
            </thead>
