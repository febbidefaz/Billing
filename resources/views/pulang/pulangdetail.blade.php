    ...
    @else
        <div class="card shadow-sm">
            ...
            <div class="card-body py-2">
                ...
                <div class="mt-3">
                    ...
                    <button type="button" class="btn btn-success btn-sm" onclick="previewBillingEditObaPay()"
                        style="display:none;">
                        <i class="fas fa-print"></i> Rek E. ObaPay
                    </button>

                    <script>
                        function previewBillingEditObaPay() {

                            window.open(
                                "{{ route('rawatinap.rekEditObapayPrint', $pasien->ID) }}",
                                "_blank",
                                "height=800,width=1000"
                            );
        ...
        <script>
            ...
            function simpanKarcisJasa() {
                ...
                $.ajax({
                    url: "{{ route('rawatinap.updateKarcisJasa', $pasien->ID) }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}",
            ...
            function hapusKarcisJasa() {
                ...
                $.ajax({
                    url: "{{ route('rawatinap.hapusKarcisJasa', $pasien->ID) }}",
                    type: "POST",
                    data: {
                        _token: "{{ csrf_token() }}"
                    },
